<link rel="icon" type="image/png" href="{{asset('assets/img/icons/favicon-196x196.png')}}" sizes="196x196" />
...
<link rel="icon" type="image/png" href="{{asset('assets/img/icons/favicon-128x128.png')}}" sizes="128x128" />
